# Calculadora-Belenus
<h1 align="center"> Calculadora BELENUS </h1> 
<h1 align="center"> BELENUS </h1> 
<p align="center">
  <img width="300" height="300" src="https://cdn-icons-png.flaticon.com/512/3233/3233478.png">
</p>

<h3>Introdução</h3>

Um projeto onde o usuário pode ter acesso a dois tipos de calculadora: a Tradicional e a de IMC.
Mas para ter acesso às duas ele precisa fazer um login com um codenome e uma senha.
...
<details><summary><b>Intalações</b></summary>
...
- `5º Passo`: Instalação E Configuração do Scene Builder:
 ...
 <p>Instalação do Java JDK 8, e um ambiente de desenvolvimento (preferencialmente Apache NetBeans IDE 12.5 - que foi usado para desenvolver este aplicativo).</p>
  </details>
  
  <details><summary><b>Funcionalidades do Projeto</b></summary>
  
- `Funcionalidade 1`: Te ajuda a calcular mais rápido.
- `Funcionalidade 2`: Saber mais sobre sua saúde.
- `Funcionalidade 3`: Te ajudar Adquerir conhecimento mais rápido.
  </details> 
<h4>
 ...
 <br>@holandalarissa</br>
 <br>@SophiaMel</br>
 </p>
  </details>
 
  <details><summary><b>Colaboradores</b></summary>
 ...
 <br>Layssa Rachel Santos de Oliveira</br>
  ...
  <details><summary><b>Contato dos colaboraddores</b></summary>
 <p>
